...
package com.ojol.kemana.fragment
...
import com.ojol.kemana.R
import com.ojol.kemana.base.*
import com.ojol.kemana.base.view.BottomSheetUnDrag
import com.ojol.kemana.fragment.bottom_sheet.MainBottomSheet
import com.ojol.kemana.fragment.bottom_sheet.PickupBottomSheet
import com.ojol.kemana.impl.view.FragmentListener
import com.ojol.kemana.impl.view.ILocationView
import com.ojol.kemana.impl.view.IMapView
import com.ojol.kemana.impl.view.IMessagingView
import com.ojol.kemana.maps_callback.PickupMaps
import com.ojol.kemana.maps_callback.ReadyMaps
import com.ojol.kemana.maps_callback.StartMaps
import com.ojol.kemana.presenter.LocationPresenter
import com.ojol.kemana.presenter.MapsPresenter
import com.ojol.kemana.presenter.MessagingPresenter
import com.ojol.kemana.remote.driver.OrderData
import com.ojol.kemana.remote.driver.Passenger
import com.ojol.kemana.remote.driver.Position
import com.ojol.kemana.remote.driver.RemotePresenter
import com.ojol.kemana.remote.place.Places
import com.ojol.kemana.remote.place.PolylineResponses
import com.ojol.kemana.remote.toJSONObject
import com.ojol.kemana.remote.toOrderData
...
class MainFragment(private val passenger: Passenger?, private val fragmentListener: FragmentListener) : RxFragment(),
    ...
    override fun mapReady(start: Places, destination: Places, polyline: PolylineResponses?) {
        ...
        if (polyline == null) {
            ...
            readyMaps = ReadyMaps(context, startLatLng, destLatLng, polyline.geometry)
